...
namespace EforTakip.Domain.Tests.Users;
...
public class UserTests
{
    ...
    {
        var act = () => User.CreateFromActiveDirectory(
    ...
    [Fact]
    public void SetPassword_OnActiveUser_Throws()
    {
        var user = User.CreateFromActiveDirectory(
    ...
    public void SetAttribute_WithReferencedUser_StoresReference()
    {
        ...
        user.Attributes.Single().ReferencedUserId.Should().Be(managerId);
    }
