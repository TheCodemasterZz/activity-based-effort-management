...
/// mevcut bir kaydın o aralığa taşınmasını engeller — onay "kapanmış dönem" anlamına gelir.
/// EntryType'a göre filtrelenir: Log Work (Actual) onayı Plan Work (Planned) kayıtlarını
/// etkilemez, ve tam tersi.</summary>
