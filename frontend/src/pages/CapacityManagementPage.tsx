  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-slate-50">
      <div className="max-w-sm rounded-xl border border-dashed border-slate-300 bg-white p-8 text-center shadow-sm">
        ...
        <h2 className="text-lg font-semibold text-slate-800">Kapasite Yönetimi</h2>
        <p className="mt-2 text-sm text-slate-500">
          Kapasite planlama ekranı yakında burada olacak. Şimdilik yalnızca gerçekleşen efor kayıtları
          (Work Log) girilebiliyor.
        </p>
      </div>
    </div>
  );
